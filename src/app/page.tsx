...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-50 via-white to-slate-50 text-slate-900 font-sans selection:bg-emerald-100">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-emerald-100/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="font-bold text-xl flex items-center gap-2 text-slate-900">
            <div className="h-8 w-8 rounded-lg bg-emerald-500 flex items-center justify-center text-white shadow-lg shadow-emerald-200">NP</div>
            NutriPlan
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="space-y-4 group">
              <div className="h-12 w-12 rounded-2xl bg-orange-50 flex items-center justify-center text-orange-600 text-2xl group-hover:scale-110 transition-transform shadow-sm">
                ⚖️
              </div>
            ...
            {/* Feature 2 */}
            <div className="space-y-4 group">
              <div className="h-12 w-12 rounded-2xl bg-purple-50 flex items-center justify-center text-purple-600 text-2xl group-hover:scale-110 transition-transform shadow-sm">
                🧬
              </div>
            ...
            {/* Feature 3 */}
            <div className="space-y-4 group">
              <div className="h-12 w-12 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 text-2xl group-hover:scale-110 transition-transform shadow-sm">
                🤝
              </div>
      ...
      <section className="py-24 px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto bg-slate-900 rounded-[2rem] p-8 md:p-16 text-center relative shadow-2xl shadow-emerald-900/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center relative z-10">
            <Button size="lg" className="rounded-full bg-white text-slate-900 hover:bg-emerald-50 h-12 px-8 font-bold shadow-lg shadow-white/10 transition-colors">
              Criar Conta Grátis
            </Button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-white/80 border-t border-slate-100 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-slate-400 text-sm">© 2024 NutriPlan. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
